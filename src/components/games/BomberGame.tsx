...
export default function BomberGame() {
    ...
    return (
        <div className="min-h-screen bg-green-800 font-sans text-white flex flex-col items-center justify-center p-4 relative overflow-hidden">

            {/* Header */}
            <div className="absolute top-4 left-4 z-20">
                <Link href="/game" className="bg-white text-green-800 px-6 py-3 rounded-full font-bold shadow-lg hover:bg-green-100 transition-colors">
                    ← もどる
                </Link>
            </div>

            <h1 className="text-3xl md:text-4xl font-black text-white mb-4 z-10 drop-shadow-sm">
                ガルちゃん ボンバー
            </h1>

            <div className="relative bg-green-600 p-4 rounded-xl shadow-2xl border-4 border-white">
                <div
                ...
                {win && (
                    <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center text-white z-30">
                        <p className="text-4xl font-black text-yellow-400 mb-4">YOU WIN!</p>
