    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-100 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-slate-900/70 p-8 rounded-lg shadow-md border border-slate-800">
                <h1 className="text-3xl font-bold mb-8 text-slate-100 border-b border-slate-700 pb-4">利用規約</h1>
                ...
                <section className="mb-8">
                    <h2 className="text-xl font-bold mb-4 text-slate-100">第1条（適用）</h2>
                    <p className="mb-4">
                ...
                <section className="mb-8">
                    <h2 className="text-xl font-bold mb-4 text-slate-100">第2条（禁止事項）</h2>
                ...
                <section className="mb-8">
                    <h2 className="text-xl font-bold mb-4 text-slate-100">第3条（本サービスの提供の停止等）</h2>
                    <p className="mb-4">
                ...
                <section className="mb-8">
                    <h2 className="text-xl font-bold mb-4 text-slate-100">第4条（免責事項）</h2>
                    <p className="mb-4">
